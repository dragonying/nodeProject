...
![1574412384514](03-大事件服务器接口文档说明.assets/1574412384514.png)

* **`如果出现双击顿闪的现象，可以尝试使用下列方法`**
...
## 8.0版本的phpstudy配置流程(用于无法安装老版本phpstudy的电脑)

* 1.点击启动mysql服务器

![1583224580801](03-大事件服务器接口文档说明.assets/1583224580801.png)



* 2.修改root密码

![1583224650533](03-大事件服务器接口文档说明.assets/1583224650533.png)

* 3.创建数据库 （注意用户名不能写root，随便写其他的）

![1583224678232](03-大事件服务器接口文档说明.assets/1583224678232.png)

* 4.进入服务器文本的config/index.js, 修改用户名和密码

![1583224704772](03-大事件服务器接口文档说明.assets/1583224704772.png)
...
- 接口认证统一使用 Token 认证
- 需要授权的 API ，须在请求头中使用 `Authorization` 字段提供 `token` 令牌
